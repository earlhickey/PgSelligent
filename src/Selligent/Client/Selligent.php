...
class Selligent extends EventProvider
{
     ...
     * @param string $apiKey Your Selligent API key
     */
    function __construct($config)
    {
        ...
        $this->apiEndpoint = sprintf('https://api.selligent.com/');
    }

    /**
     * Subscribe
     * docs: http://apidocs.selligent.com/api/2.0/lists/subscribe.php
    ...
    /**
     * Unsubscribe
     * docs: http://apidocs.selligent.com/api/2.0/lists/unsubscribe.php
     * @return array
     */
